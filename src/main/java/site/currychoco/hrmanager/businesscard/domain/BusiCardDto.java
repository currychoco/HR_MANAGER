...
public class BusiCardDto {
    ...
    public static BusiCardDto fromEntity(EmployeeAllInfo empInfo){
        ...
        return new BusiCardDto(
                ...
                empInfo.getDepartment().getDeptName(),
                empInfo.getDepartment().getDeptNameEn(),
                empInfo.getJob().getJobName(),
                empInfo.getJob().getJobNameEn(),
                empInfo.getPosition().getPositionName(),
                empInfo.getPosition().getPositionNameEn(),
                empInfo.getEmail(),
                empInfo.getPhone(),
                "R",
